...
class ModelArguments:
    ...
    padding_side: Optional[str] = field(
        default="right",
        metadata={"help": "padding direction"}
    )
...
model_class = {
    "chatglm": AutoModelForSeq2SeqLM,
    "chinese_alpaca": LlamaForCausalLM,
    "chinese_bloom": AutoModelForCausalLM,
    "llama": AutoModelForCausalLM,
}

tokenizer_class = {
    "chatglm": AutoTokenizer,
    "chinese_alpaca": LlamaTokenizer,
    "chinese_bloom": AutoTokenizer,
    "llama": AutoTokenizer,
}
...
def extract_alpaca_dataset(example, model_name):
...
def make_data_module(tokenizer: transformers.PreTrainedTokenizer, args) -> Dict:
    ...
    # =====================================
        ...
        dataset = load_dataset("json", data_files=["./data/{}/instruct_data/train.json".format(args.dataset)],
                               field="data")
        dataset = dataset.map(lambda x: extract_alpaca_dataset(x, args.model_name), remove_columns=['instruction'])
    # =====================================
    # =====================================
...
def train():
    ...
    # Tokenizer
    tokenizer = tokenizer_class[args.model_name].from_pretrained(
        args.model_name_or_path,
    ...
    if not args.full_finetune:
        ...
        trainer.add_callback(PeftSavingCallback)
