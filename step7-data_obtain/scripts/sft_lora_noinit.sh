...
do
DS_SKIP_CUDA_CHECK=1 deepspeed --include localhost:1,2,3,4 lora_prompt_embedding.py \
    --model_dir /home/data/qinchuan/TMIS/llm_models/${model_name} \
    --output_dir /home/data/qinchuan/TMIS/paper_code/output/data_obtain/lora_noinit/${model_name} \
